...
#pygame is much, much more responsive than turtle
# Initialize Pygame
pygame.init()
...
# why do they want everything in one giant function? it's better than having a giant __main__ function, but still nearly unreadable
def gameLoop():
    game_over=False
    game_close=False
    ...
    while not game_over:
        while game_close:
            screen.fill(BLACK)
            message("You lost! Press Q to quit or C to play again", RED, WIDTH / 6, HEIGHT / 3)
